...
**Test steps:**
1. Open MissionHelm in two browser windows side-by-side
...
**Test steps:**
1. Open MissionHelm in 3 different browsers (Chrome, Firefox, Safari)
...
1. **Hermès (main agent) creates task:**
   ```bash
...
1. Delete `missionhelm.db` and restart (recreates schema)
